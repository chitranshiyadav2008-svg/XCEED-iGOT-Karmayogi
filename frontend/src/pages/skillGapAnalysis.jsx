    ...
    <div className="skill-gap-page">
      ...
      <header className="skill-gap-nav">
        ...
        <div className="skill-gap-brand">
          ...
          <div>
            ...
            <span>Karmayogi Competency Platform</span>
          </div>
        </div>
        ...
        <div className="skill-gap-profile">
          ◯ Officer Profile
        </div>
      ...
      <section className="skill-gap-header">
        ...
        <div className="skill-gap-container">
          ...
          <div className="skill-gap-breadcrumb">
            Home
            <span>›</span>
            My Roles
            <span>›</span>
      ...
      <main className="skill-gap-container skill-gap-main">
        ...
        <section className="skill-gap-card role-card">
          ...
          <div>
            ...
            <p>
              Your Skill Twin is compared with the competency requirements
              of your selected role to identify priority gaps.
            </p>
        ...
        <div className="priority-grid">
          ...
          <section className="skill-gap-card priority-card">
            ...
            <div className="priority-stats">
              ...
              <span>
                Gap:{' '}
                <b>
                  {data.priority.gap} points
                </b>
              </span>

            </div>

            <div className="bar-wrap priority-bar">

              <div
                className="bar-required"
                style={{
                  width: `${data.priority.required}%`
                }}
              />

              <div
                className="bar-current danger"
                style={{
                  width: `${data.priority.current}%`
                }}
              />
          ...
          <section className="skill-gap-card">
            ...
            <p className="muted">
              Strengthening Survey Design directly increases your readiness
              across core responsibilities of the Statistical Investigator role.
            </p>
        ...
        <section className="skill-gap-card recommended">
          ...
          <div className="recommended-inner">
            ...
            <div className="actions">
              ...
              <button onClick={goToLearningPath}>
                Start Learning
              </button>
        ...
        <section className="skill-gap-card simulator">
          ...
          <div>
            ...
            <h2>
              Want to see how learning could improve your readiness?
            </h2>

            <p>
              Use the What-If Simulator to model how completing
              recommended courses could raise your competency levels
              and overall role readiness.
            </p>
          ...
          <button onClick={goToWhatIfSimulator}>
